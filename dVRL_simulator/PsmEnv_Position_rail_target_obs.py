...
from dVRL_simulator.vrep.simObjects_pickplacetarget import table, target, rail, obs1 #, obs2, obs3
...
class PSMEnv_Position_pickplace_tobs(PSMEnv):
    ...
    def __init__(self, psm_num, n_substeps, block_gripper, has_object,
        ...
        super(
            PSMEnv_Position_pickplace_tobs,
            self).__init__(
            psm_num=psm_num,
        ...
        self.obs1 = obs1(self.clientID)
        #self.obs2 = obs2(self.clientID)
        #self.obs3 = obs3(self.clientID)
    ...
    def _sample_goal(self):
        ...
        if self.randomize_target:
            ...
            initial_tt_offset = 0 # no need of offset for the goal
            goal = self._random_testing_volume(initial_tt_offset, b_T_table)  
