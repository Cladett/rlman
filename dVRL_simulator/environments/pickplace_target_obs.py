...
from dVRL_simulator.PsmEnv_Position_rail_target_obs import PSMEnv_Position_pickplace_tobs
import numpy as np

class PSMPickPlaceTargetObsEnv(PSMEnv_Position_pickplace_tobs):
    def __init__(self, psm_num = 1, reward_type='sparse',
        ...
        super(PSMPickPlaceTargetObsEnv, self).__init__(psm_num=psm_num, n_substeps=1,
