...
class PSMPickPlaceTargetEvalE1Env(PSMEnv_Position_pickplace_t_eval):
    def __init__(self, psm_num = 1, reward_type='sparse',
                 randomize_obj=False, randomize_obj_orientation=False,
        ...
        super(PSMPickPlaceTargetEvalE1Env, self).__init__(psm_num=psm_num, n_substeps=1,
