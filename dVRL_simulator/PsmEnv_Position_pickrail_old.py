...
from dVRL_simulator.vrep.simObjects_pickplacetarget import table, rail, target 
...
class PSMEnv_Position_pickrail(PSMEnv):
    ...
    def __init__(self, psm_num, n_substeps, block_gripper,
            ...
            randomize_initial_pos_ee, #x_range, y_range, z_range,
        ...
        super(PSMEnv_Position_pickrail, self).__init__(
    ...
    def _sample_goal(self):
        ...
        @Returns: goal.copy, position of the rail i want to reach.
    ...
    def _is_success(self, achieved_goal, desired_goal):
        ...
        # When the tool is very close to the target and has grasped the object
