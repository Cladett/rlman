...
from dVRL_simulator.vrep.simObjects_reachkid import table, rail, targetK  
...
class PSMEnv_Position_reachkid(PSMEnv):
    ...
    def _sample_goal_neri(self, initial_pos_k = [0.05, -0.05, 0]):
        '''
        @Info: 
    ...
    def _sample_goal(self):
        ...
        # Sampling target. The target is the central dummy. If tandomized false, the 
